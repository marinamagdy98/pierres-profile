...
Contributors: droitthemes, golaphazi, kazisayed, webrahaman, rafs45, rony015
...
👁️ [View Demo](https://droitthemes.com/droit-dark-mode/) | 👑  [Get The PRO Version](https://droitthemes.com/droit-dark-mode/) | 👍 [Get Support](https://droitthemes2.ticksy.com/submit/)
...
* Fix: Content Updated.
* Fix: Deprecated function update.
* Fix: API issue fixed.
* Fix: Pro licance actived issue solved.
...
* New: OS Based Settings
* New: OS Based Dark Mode
