<div class="droit_setting_container">
	...
	<div class="droit_setting_wrapper image-replace <?php _e(($pro) ? 'drdt-disabled ' : ''); ?>">
		...
		<div class="droit_setting_switcher">
			...
			<p class="droit_setting_desc"><?php _e( 'Open WordPress ', 'droit-dark-mode' );?><a href="<?php echo get_admin_url(); ?>upload.php"><b>Media > Library</b> </a> <?php _e( 'click the image to open details, copy the File URL and paste it here.', 'droit-dark-mode' );?></p>
		</div>
	</div>
</div>
